...
const socialIcons: SocialIcons = {
  ...
  Work: `<svg class="icon-tabler" viewBox="10 286 625 220" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
  <g>
	<g> 
  <path fill="#F8F8F8" d="M301.6,387.6h-57.1c3.5-12.9,15.2-21.4,27.6-21.4C287.5,366.2,297.7,373.8,301.6,387.6 M244.2,407.2H328
...
<path fill="#F8F8F8" d="M365.8,400c0-17.9,12.9-31.3,29.9-31.3c17,0,30.4,14.3,30.4,30.8c0,17.3-12.9,30.8-31.7,30.8
...
<path fill="#F8F8F8" d="M468,347.5h23.2v104.3H468V347.5z M468,313.5h23.2v23.2H468V313.5z"/>
<path fill="#F8F8F8" d="M531.9,398.2c0-17,13.4-29.9,29.9-29.9c15.2,0,29.4,13.4,29.4,31.3c0,16.1-13.8,29.9-29,29.9
  ...
  c-9.7,10.3-14.7,23.7-14.7,38.4c0,31.3,23.2,54.8,53.9,54.8c16.1,0,26.7-4.4,32.5-15.2V451.8z"/>
	...
	<polygon fill="#F8F8F8" points="6,497.2 69.6,497.2 138.4,428.6 207,497.2 271.4,497.2 170.6,396.4 272.3,294.8 207.9,294.8
