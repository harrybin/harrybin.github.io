...
<Hint type="info">
  You can install MCP servers directly from the [GitHub MCP server
  registry](https://github.com/mcp) via VS Code's Extensions view. Enable the
  `chat.mcp.gallery.enabled` setting and search for `@mcp`.
</Hint>
