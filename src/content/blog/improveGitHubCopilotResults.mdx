...
Without giving a full overview what's possible, this the minimum I do for my projects:

## Create instruction files!

One of the most effective ways to improve GitHub Copilot's results in your projects is by creating instruction files. These files provide context and guidelines that help Copilot understand your project at all, the project's structure, your coding standards and specific requirements.
...
![](/assets/vscodechatmodecreation.png)
...
- Use chat modes for broader task-oriented interactions that require different AI behaviors, like code reviews, testing behavoir or API design
