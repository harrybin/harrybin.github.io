...
tags:
  ...
  - AI
description: A recap of my BMAD talk and demo that shows how GitHub Copilot can turn vague requirements into PRDs, context, test design, and traceable ATDD artifacts.
---

## Why I gave this session

At ADC 2026, I presented a session called _KI gestutzte Anforderungs und Testfallentwicklung_.
...
The session walked through that journey with BMAD and GitHub Copilot, and the demo used a real branch with exported Copilot chat history so every step is transparent.
...
The session focused on a practical sequence:
...
In the demo, architecture stayed connected to the earlier requirements and risk discussion.
